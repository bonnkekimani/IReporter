      ...
      <div className="overlap-wrapper">
        <div className="overlap">
          <div className="overlap-2">
            ...
            {/* <Rejected className="icon-rejected" /> */}
          </div>
            ...
            <div className="HEADER">
              <div className="overlap-group-2">
                {/* <Header
                  ...
                  headertabitemClassName="header-3"
                  headertabsDefaultClassName="header-2"
                /> */}
                <div className="USER">
                  <PersonPinIcon className="img-2"/>
                  <div className="NAME">
                    <div className="text-wrapper-4">ALVIN ADAMS</div>
                  </div>
                </div>
                {/* <Down className="icon-chevron-down" />
                <Notification className="icon-notification" /> */}
                <div className="search-bar">
                  <div className="what-would-you-like">Search Data</div>
                  {/* <img className="icon-UI-search" alt="Icon UI search" src="search.svg" /> */}
                </div>
              </div>
            </div>
